    ...
    return (
      <View className='goodsInfoWrap'>
        ...
        <View className='numWrap'>
          <View className='totalMoney'>合计：<Text>{this.state.totalMoney}</Text></View>
        ...
        <View className='tabsWrap'>
          ...
          <View className='tabsCon'>
            <Image
              mode='widthFix'
              src={currentTab === 0 ? goodInfo.goodPic
                : currentTab === 1 ? 'https://gitee.com/summersnake/images/raw/master/others/saber.jpg'
        ...
        <View className='goodInfoBottom'>
          ...
          <View className='botBtnWrap'>
            <View className='addToCart' onClick={this.btnClick.bind(this, 'add')}>加入购物车</View>
